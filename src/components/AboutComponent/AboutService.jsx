...
const CardData = [
  {
    src: people,
    name: "People",
    desc: "We understand that our people impact the success of our business, and we hire people who are smart, dedicated for Techilab.",
  },
  {
    src: customerService,
          ...
          <Wrapper className="d-flex flex-row align-items-center justify-content-between gap-5">
            ...
            <Wrapper>
              ...
              <P color="gray" size="16px" weight="500" className="mt-4">
                Techilab have the expertise and resources required to design,
